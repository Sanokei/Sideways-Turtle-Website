(function LoaderScreenScript(window = window, document = window.document, undefined = window.undefined || void 0) {
    ...
    let processingTime = 0,
        ...
        loaderScreenOpacity = typeof window.loaderScreenOpacity != 'undefined' ? window.loaderScreenOpacity : .95,
            ...
            // Modification > Data
                ...
                data.innerHTML =
                    '<style media=all type=text/css>' +
                        ...
                        '}' +
                    '</style>' +
                    "<div style='animation: rotate 1s ease-in-out 0s infinite backwards; border: " + loaderScreenWidth + "px solid rgba(255, 255, 255, " + loaderScreenOpacity + "); border-top-color: rgba(0, 51, 255, " + loaderScreenOpacity + "); border-radius: 50%; height: 75px; margin: 0 auto; margin-bottom: " + loaderScreenMargin + "px; width: 75px; z-index:5000' > </div>" +
                ...
                // Style
                data.style = 'align-items: center; background-color: rgba(0, 0, 0, .98); display: flex; flex-direction: column; height: ' + innerHeight + 'px; justify-content: center; left: 0; margin: auto; max-height: 100% !important; max-width: 100% !important; min-height: 100vh; position: fixed; top: 0; transition: ' + loaderScreenTransition + 's ease-in-out; width: ' + innerWidth + 'px; z-index: 2147483647';
